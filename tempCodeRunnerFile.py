...
while not won_or_tie:
    # Check if the large grid is won before the turn
    ...
    if turn % 2 == 0:
        ...
        # if the next large grid is not set, ask for the large grid input
        ...
        game_state[selected_grid][small_grid_index] = human1

        next_large_grid = small_grid_index

        printGameState()
        check_small_grid_win_state(selected_grid)
        # if the small grid is won, print the game state and large grid state
        if check_small_grid_win_state(selected_grid) != None:
            printGameState()
        ...
        small_grid_index = get_small_grid_input(selected_grid)
        game_state[selected_grid][small_grid_index] = human2
