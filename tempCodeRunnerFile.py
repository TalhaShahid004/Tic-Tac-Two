...
def gui():
    ...
    def show_winner_popup():
        if player_won_or_tie == 'tie':
            ...
            message = f"Player {player_won_or_tie} wins!"
    ...
    def update_gui():
        for i in range(9):
            ...
            for j in range(9):
                ...
                if won_or_tie:
                    ...
                    if player_won_or_tie == 'X':
                        button.configure(fg_color="blue")
                    elif player_won_or_tie == 'O':
                        button.configure(fg_color="red")
                    elif player_won_or_tie == 'tie':
        ...
        if won_or_tie:
            # Highlight winning 3 in a row squares
            if player_won_or_tie != 'tie':
                for i in range(9):
                    if large_grid_state[i] == player_won_or_tie:
        ...
        if won_or_tie:
            turn_label.configure(text=f"Player {player_won_or_tie} wins!" if player_won_or_tie != 'tie' else "It's a tie!")
        else:
            turn_label.configure(text=f"Player {player}'s turn")
